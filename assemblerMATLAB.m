...
for i = 1:numel(lines)
    ...
    for j = 1:length(line)
        ...
        %D
         if(character1 =='D'&&character2=='=')
           decimall{i}=16+57344;
            temp{i} = line(3:end);
         end
         %M
         if(character1 =='M'&& character2=='=')
            decimall{i}=8+57344;
            temp{i} = line(3:end);
         end
         %A
           if(character1 =='A'&& character2=='=')
            decimall{i}=32+57344;
            temp{i} = line(3:end);
           end
           %AM
            if(character1 =='A'&&character2 =='M'&& character3=='=')
            decimall{i}=40+57344;
            temp{i} = line(4:end);
            end
            %AMD
            ...
            %MD
             if(character1 =='M'&&character2 =='D'&& character3=='=')
            decimall{i}=24+57344;
            temp{i} = line(4:end);
             end
              %AD
            if(character1 =='A'&&character2 =='D'&& character3=='=')
            decimall{i}=48+57344;
            temp{i} = line(4:end);
            end
              %nul
...
fileID_write = fopen("C:\Users\abdul\Desktop\gp\assembler\AAMM.hack", 'w');
